...
public class PetController {
    ...
    @GetMapping("/{id}")
    public PetDto getPetById(@PathVariable("id") Long petId) {
        try {
    ...
    @PostMapping
    public PetDto addPet(@RequestBody PetRequest petRequest) {
    ...
    @PutMapping
    public PetDto updatePet(@RequestBody PetRequest petRequest) {
        try {
